...
import "./CookieFountain.scss";

// function CookieFountain() {
//   return (
//     <>
//       <h1 className="test">Cookie Fountain!</h1>
//     </>
//   );
// }

// export default CookieFountain;

class CookieFountain extends React.Component {
  constructor() {
    super();
    this.state = {
      rows: [
